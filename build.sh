#!/usr/bin/env bash
# =============================================================================
# Inventory UI Build and Deploy Script
# =============================================================================
...
# Configuration
APP_NAME=${APP_NAME:-"inventory-ui"}
...
GIT_USER=${GIT_USER:-"Inventory UI Bot"}
...
NEXT_PUBLIC_API_URL=${NEXT_PUBLIC_API_URL:-"https://inventoryapi.codevertexitsolutions.com"}
