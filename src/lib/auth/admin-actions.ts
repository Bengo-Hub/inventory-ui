 ...
 * proxying through inventory-api — auth-api is the sole owner of both the account record and
 * the password, so inventory-api has nothing useful to add as a middle hop, and CORS is
 * already open for this origin (the same origin revokeServerSession/logout already rely on).
 */
