...
/**
 * Catches any render-time error inside a tenant route (catalog, item form, etc.) that no
 * inner try/catch or query error-state handled — the previous behavior with no error boundary
