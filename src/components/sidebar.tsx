...
// USE_CASE_MODULES / UNIVERSAL_MODULES / hasModule now live in '@/lib/use-case-modules' so the
// Settings page can share the exact same gating (see that file for the full doc comment).
  ...
  const allNavGroups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Backups', icon: DatabaseBackup, href: '/backups', moduleKey: 'settings' },
