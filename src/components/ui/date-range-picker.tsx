...
// Quick presets — rolling windows plus the explicit Custom from/to pickers below.
 ...
 * (no external calendar dependency). Ported from pos-ui's `components/ui/date-range-picker`
 * (same API) to give inventory-ui's list pages the same filter UX.
 */
export function DateRangePicker({
  ...
  // Anchor the panel to the trigger with fixed positioning so it escapes any ancestor's
  // `overflow-hidden`/`overflow-y-auto` clipping, and keep it inside the viewport on narrow screens.
  const reposition = () => {
