...
- [x] **F1-06:** Axios instance (`lib/api/client.ts`) with inventory-api base URL, auth headers, outlet header
  ...
  - Base URL: `https://inventoryapi.codevertexafrica.com/v1/{tenantID}`
